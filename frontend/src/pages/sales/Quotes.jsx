...
function Quotes() {
  ...
  useEffect(() => { fetchQuotes(); fetchCustomers(); fetchItems(); }, []);
    ...
    <div className="h-full flex flex-col">
      <div className="erp-toolbar">
        ...
        <div className="ml-auto text-xs">View:
          <select className="erp-form-select ml-1" value={statusFilter} onChange={e => { setStatusFilter(e.target.value); setTimeout(fetchQuotes, 0); }}>
